@component('admin.layouts.content', ['title' => 'ویرایش مقام'])
    ...
    <div class="col-lg-6">
        ...
        <div class="card">
            <div class="card-body">
                <h4 class="header-title">فرم ویرایش مقام</h4>
                <br>
                <form role="form" class="parsley-examples" novalidate="" action="{{ route('admin.roles.update', $role->id) }}" method="POST">
                    @csrf
                    @method('PATCH')
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-7">
                            <input type="text" name="name" required="" class="form-control" placeholder="عنوان مقام" value="{{ old('name', $role->name) }}">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-7">
                            <input type="text" name="label" placeholder="توضیح مقام" required="" class="form-control" value="{{ old('label', $role->label) }}">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-8 offset-4">
                            <button type="submit" class="btn btn-primary waves-effect waves-light">ویرایش مقام</button>
