    ...
    <div class="col-lg-6">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form role="form" class="parsley-examples" novalidate="" action="{{ route('admin.products.update', $product->id) }}" method="POST">
                    @csrf
                    @method('PATCH')
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-7">
                            <input type="text" name="title" required="" class="form-control" placeholder="نام محصول" value="{{ old('title', $product->title) }}">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-7">
                            <input type="number" name="price" required="" placeholder="قیمت را وارد کنید" value="{{ old('price', $product->price) }}" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-7">
                            <input type="number" name="inventory" placeholder="موجودی را وارد کنید" value="{{ old('inventory', $product->inventory) }}" required="" class="form-control">
                        </div>
                    </div>

                    <div class="row mb-3">
                        <div class="col-8 offset-4">
                            <button type="submit" class="btn btn-primary waves-effect waves-light">ویرایش محصول</button>
